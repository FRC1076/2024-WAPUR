...
/** Helper functions for the drivetrain */
public class Helpers {
    private Helpers() {}

    /** Creates speed vector from given controller inputs 
     * 
     * @param xValue the speed input in the x direction, should be scaled between -1.0 and 1.0
